...
btnDecline.onclick = async () => {
  ...
  const res = await fetch(
    `http://localhost:5000/api/orders/admin/cancel-request/decline/${activeCancelOrderId}`,
    {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${token}`,
...
btnApprove.onclick = async () => {
  ...
  const res = await fetch(
    `http://localhost:5000/api/orders/admin/cancel-request/approve/${activeCancelOrderId}`,
    {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${token}`,
  ...
  yesBtn.onclick = async () => {
    ...
    setTimeout(async () => {
      const res = await fetch(
        `http://localhost:5000/api/orders/admin/delete/${orderId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
